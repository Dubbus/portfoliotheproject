...
+----------------------------------------+
|               Standard                |
|   (from OSU components.standard)      |
+-----------------^----------------------+
                  |
                  |
+-----------------+----------------------+
|   BookRecommenderKernel (interface)   |
|   extends Standard                    |
|---------------------------------------|
| + addBook(Book b) : void             |
...
+-----------------^----------------------+
                  ...
                  |
+-----------------+----------------------+
|   BookRecommender (interface)         |
|   extends BookRecommenderKernel       |
|---------------------------------------|
| + getRecommendations(String title)    |
|       : Sequence<Book>                |
+-----------------^----------------------+
                  |
                  |
+-----------------+----------------------+
|   BookRecommender1 (class)            |
|   implements BookRecommender          |
|---------------------------------------|
...
i have no idea where to put records so i put them in here!
